...
export const STR: Record<LangKey, Strings> = {
  fr: {
    ...
    drop_title: "Déposez le plan scanné", drop_hint: "JPG, PNG ou PDF — un ou plusieurs feuillets", detected: "Détection préliminaire", ocr_engine: "Moteur OCR",
    ...
    map_title: "Tracé de la parcelle", map_plan: "Plan", map_sat: "Satellite", sat_note: "Fond satellite indicatif — visualisation uniquement, non référence cadastrale.", map_local: "CRS non géoréférencé : affichage satellite désactivé.",
  ...
  en: {
    ...
    drop_title: "Drop the scanned plan", drop_hint: "JPG, PNG or PDF — one or several sheets", detected: "Preliminary detection", ocr_engine: "OCR engine",
    ...
    map_title: "Parcel outline", map_plan: "Plan", map_sat: "Satellite", sat_note: "Indicative satellite background — visualization only, not a cadastral reference.", map_local: "Non-georeferenced CRS: satellite display disabled.",
