...
export const STR: Record<LangKey, Strings> = {
  fr: {
    ...
    map_title: "Tracé de la parcelle", map_plan: "Plan", map_sat: "Satellite", sat_note: "Imagerie satellite — visualisation uniquement, sans valeur de preuve foncière.",
  ...
  en: {
    ...
    map_title: "Parcel outline", map_plan: "Plan", map_sat: "Satellite", sat_note: "Satellite imagery — visualization only, no value as boundary proof.",
